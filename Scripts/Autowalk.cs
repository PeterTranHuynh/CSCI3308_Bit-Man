 ...
 * @file Autowalk.cs
 *
 * @brief This script moves your player automatically in the direction he is looking at. 
 * 
 * You can activate the autowalk function by pull the cardboard trigger, by define a threshold angle 
