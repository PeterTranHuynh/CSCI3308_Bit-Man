/** 
 *
 * @file characterMotor.cs
 *
 * @brief Character motor holds all the values for the speed and movement of a 3D object within unity and handles collision.
 *
 * @author Peter Huynh 
 * @author Cary Sullivan
 *
 * @bug Accelerates spontaniously if attached to a camera
 * 
 */
...
public class CharacterMotor : MonoBehaviour
{
	...
	/** 
	 * @brief Use for updating movement properties
	 * @param None
	...
	/** 
	 * @brief Used for updating movement properties if on a moving 3d platform or object.
	 * @param None
	 * @return Should not return.
	 */
	void FixedUpdate()
	...
	/** 
	 * @brief Detects collider data within a 3D object
	 * @param Takes in instance of a collider class 
	 * @return Should not return.
	 */
	...
	/** 
	 * @brief Instance of vector class used for movement directions
	 * @param Boolean to check for controllable object
	 * @return Boolean to new controllable object
	 */
	...
	/** 
	 * @brief Project a direction onto elliptical quater segments based on forward, sideways, and backwards speed.
	 * @param Instance of vector class used for movement directions
	 * @return The function returns the length of the resulting vector.
	 */
	...
	/** 
	 * @brief Sets new speed of 3d object in the game
	 * @param Instance of vector class used for velocity
	 * @return Should not return.
	 */
